...
Analysed the NEAT-AI-Examples project and created 7 improvement suggestions as
GitHub issues, as requested in issue #7. Also added a `suggest_improvements/`
module that codifies the analysis process with full test coverage.
...
- Added `suggest_improvements/suggest_improvements.ts` — project analyser that
  identifies improvement opportunities and outputs structured suggestions
- Added `suggest_improvements/suggest_improvements_test.ts` — 12 unit tests
  verifying the analysis and summary generation functions
...
- 12 new tests in `suggest_improvements/suggest_improvements_test.ts`:
  ...
  - `analyseProject` includes CI/CD, code quality, documentation, and new
    example suggestions
