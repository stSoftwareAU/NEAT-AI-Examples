...
| [🔬 Discovery at Scale](discovery_at_scale/README.md)                 | 🛠 technique   | Evolve a 9-neuron minimal seed via `evolveDir` until it reproduces the labels of a moderately-large hand-crafted reference creature; emit per-generation telemetry CSV + fitness/topology charts.       | `./discovery_at_scale/run.sh`   |
