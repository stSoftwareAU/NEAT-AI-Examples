...
| ---------------------------------- | ----------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Defect-aware repair at scale       | [🔬 Discovery at Scale](discovery_at_scale/README.md) | Inject saturated, dead, dormant, and bottleneck defects into a ~200-neuron creature; run discovery; render before/after topology with a defect-category legend. | ![Discovery at Scale — before/after topology of a ~200-neuron creature with injected defects, recovered via evolutionary search](docs/screenshots/discovery_at_scale.svg)                      |
...
| Size-driven mutation policy        | [🧬 Adaptive Mutation](adaptive_mutation/README.md)   | The topology-vs-weight mutation share shifts automatically with creature size — small creatures keep growing, large creatures focus on weight tuning.           | ![Adaptive Mutation — small vs large creature, two-panel chart of topology share collapsing toward zero on the large run while weight share dominates](docs/screenshots/adaptive_mutation.svg) |
